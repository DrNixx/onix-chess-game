import { AnalyseGame } from '../js/chess/games/analyse/AnalyseGame';
import { GameProps } from '../js/chess/games/GameProps';
...
export const GameTest = AnalyseGame(props, document.getElementById("boardHere")!);